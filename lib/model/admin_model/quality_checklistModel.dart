...
class QualitychecklistModelAdmin {
  QualitychecklistModelAdmin({
    required this.srNo,
  ...
  factory QualitychecklistModelAdmin.fromJson(Map<String, dynamic> json) {
    return QualitychecklistModelAdmin(
      srNo: json['srNo'],
