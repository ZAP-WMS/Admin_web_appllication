...
import 'package:web_appllication/screen_user/dashboard/demand%20energy%20management/bar_graph.dart';
import 'package:web_appllication/screen_user/dashboard/demand%20energy%20management/demand_table.dart';
...
class _DemandEnergyScreenState extends State<DemandEnergyScreen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          actions: [
            Consumer<DemandEnergyProviderUser>(
  ...
  Future<void> getAllDepoDailyData() async {
    try {
      ...
      final provider = Provider.of<DemandEnergyProviderUser>(
        context,
        listen: false,
      );
      ...
      final selectedCityName = Provider.of<DemandEnergyProviderUser>(
        context,
        listen: false,
      ).selectedCity;
