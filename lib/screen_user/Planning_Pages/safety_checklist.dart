...
class SafetyChecklistUser extends StatefulWidget {
  String? cityName;
  String? depoName;
  String? userId;
  String role;
  ...
  @override
  State<SafetyChecklistUser> createState() => _SafetyChecklistUserState();
}
...
class _SafetyChecklistUserState extends State<SafetyChecklistUser> {
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData ||
                              ...
                              alldata.forEach((element) {
                                safetylisttable.add(
                                    SafetyChecklistModelUser.fromJson(element));
  ...
  List<SafetyChecklistModelUser> getData() {
    return [
