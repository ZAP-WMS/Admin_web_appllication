...
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_EP.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_acdb.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_cdi.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_charger.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_ci.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_cmu.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_ct.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_msp.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_pss.dart';
import '../../QualityDatasource/user/qualityElectricalDatasource/quality_rmu.dart';
...
class ElectricalQualityChecklistUser extends StatefulWidget {
  String? cityName;
  String? depoName;
  String? currentDate;
  String? userId;
  ...
  @override
  State<ElectricalQualityChecklistUser> createState() =>
      _ElectricalQualityChecklistUserState();
}

class _ElectricalQualityChecklistUserState
    extends State<ElectricalQualityChecklistUser> {
      ...
      for (QualitychecklistModelUser mapData in data) {
        ...
        rows.add(pw.TableRow(children: [
          ...
          pw.Container(
              padding: const pw.EdgeInsets.all(2.0),
              child: pw.Center(
                  child: pw.Text(mapData.reference ?? '',
                      textAlign: pw.TextAlign.center,
                      style: const pw.TextStyle(fontSize: 14)))),
          pw.Container(
              padding: const pw.EdgeInsets.all(2.0),
