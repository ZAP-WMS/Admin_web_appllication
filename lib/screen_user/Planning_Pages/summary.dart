...
import 'package:web_appllication/widgets/widgets_user/date_input_format.dart';
...
import '../../provider/provider_user/summary_provider.dart';
...
class _ViewSummaryState extends State<ViewSummary> {
  ...
  SummaryProviderUser? _summaryProvider;
  Future<List<DailyProjectModelUser>>? _dailydata;
  Future<List<EnergyManagementModelUser>>? _energydata;
  ...
  List<EnergyManagementModelUser> energymanagement =
  ...
  CheckboxProviderUser? _checkboxProvider;
  List<int> pdfData = [];
  String? pdfPath;
            ...
            : Column(
                children: [
                                          ...
                                          textFieldConfiguration:
                                            ...
                                            onSubmitted: (value) {
                                              if (_formkey.currentState!
                                                  .validate()) {
                                                DateInputFormatter(_dateRegExp);
                                                print(value);
                                                DateTime date =
                                ...
                                child: Form(
                                  ...
                                  child: TypeAheadFormField<String>(
                                    textFieldConfiguration:
                                      ...
                                      onSubmitted: (value) {
                                        if (_formkeyenddate.currentState!
                                            .validate()) {
                                          DateInputFormatter(_dateRegExp);
                                          DateTime date =
                                              DateFormat('MMMM d, yyyy')
                                    ...
                                    suggestionsCallback: (pattern) {
                                      // Apply formatting logic to the pattern here if needed
                                      final formattedPattern = pattern
                                          .replaceAll(RegExp(r'[^\w\s]+'), '');

                                      // Filter suggestions based on the formatted pattern
                                      return _suggestions.where((fruit) => fruit
                                          .toLowerCase()
                                          .contains(
                                    ...
                                    onSuggestionSelected: (suggestion) {
                                      DateTime date = DateFormat('MMMM d, yyyy')
                                          .parse(suggestion);
                                      setState(() {
                                        enddate = date;
                                      });
                                ...
                                child: Form(
                                  ...
                                  child: TypeAheadFormField<String>(
                                    ...
                                    suggestionsCallback: (pattern) {
                                      ...
                                      // Filter suggestions based on the formatted pattern
                                      return _monthsuggestion.where((fruit) =>
                                          fruit.toLowerCase().contains(
                                              formattedPattern.toLowerCase()));
                                    },
                                    itemBuilder: (context, suggestion) {
                                    ...
                                    onSuggestionSelected: (suggestion) {
                                      DateTime date = DateFormat('MMMM yyyy')
                                          .parse(suggestion);
                  ...
                  widget.id == 'Monthly Report'
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (!snapshot.hasData ||
                                  ...
                                  alldata.forEach((element) {
                                    monthlyProject.add(
                                        MonthlyProjectModelUser.fromjson(
                                            element));
                      ...
                      : widget.id == 'Daily Report'
                          ? Expanded(
                              child: Consumer<SummaryProviderUser>(
  ...
  Future<void> _generateEnergyPDF() async {
    ...
    if (energymanagement.isNotEmpty) {
      for (EnergyManagementModelUser mapData in energymanagement) {
  ...
  Future<void> _generateDailyPDF() async {
    pr!.style(
      ...
      maxProgress: 100.0, padding: const EdgeInsets.all(0.0),
    ...
    final summaryProvider =
        Provider.of<SummaryProviderUser>(context, listen: false);
  ...
  Future<void> _generateSafetyPDF() async {
    ...
    if (alldata.isNotEmpty) {
      ...
      for (SafetyChecklistModelUser mapData in safetylisttable) {
  ...
  Future<void> _generateMonthlyPdf() async {
    ...
    if (monthlyProject.isNotEmpty) {
      for (MonthlyProjectModelUser mapData in monthlyProject) {
        // String selectedDate = DateFormat.yMMMMd().format(startdate!);
  ...
  _showCheckboxDialog(BuildContext context,
      CheckboxProviderUser checkboxProvider, String depoName) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Consumer<CheckboxProviderUser>(
          builder: (context, value, child) {
            return Container(
