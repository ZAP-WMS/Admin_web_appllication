...
import 'package:web_appllication/widgets/widgets_user/loading_pdf.dart';
import 'package:web_appllication/widgets/widgets_user/quality_list.dart';
import 'package:web_appllication/widgets/widgets_user/user_style.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_Ironite_flooring.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_backfilling.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_ceiling.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_excavation.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_flooring.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_glazzing.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_inspection.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_massonary.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_painting.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_paving.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_proofing.dart';
import '../../QualityDatasource/user/qualityCivilDatasource/quality_roofing.dart';
...
List<QualitychecklistModelUser> qualitylisttable1 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable2 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable3 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable4 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable5 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable6 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable7 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable8 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable9 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable10 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable11 =
    <QualitychecklistModelUser>[];
List<QualitychecklistModelUser> qualitylisttable12 =
    <QualitychecklistModelUser>[];
...
class CivilQualityChecklistUser2 extends StatefulWidget {
  String? cityName;
  String? depoName;
  String? currentDate;
  bool? isHeader;
  ...
  State<CivilQualityChecklistUser2> createState() =>
      _CivilQualityChecklistUser2State();
}

class _CivilQualityChecklistUser2State
    extends State<CivilQualityChecklistUser2> {
  ProgressDialog? pr;
  final AuthService authService = AuthService();
  List<String> assignedDepots = [];
  bool isFieldEditable = false;
  List<bool> civilTabBool = [];
  List<QualitychecklistModelUser> data = [];
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data.exists == false) {
                      ...
                      alldata.forEach((element) {
                        qualitylisttable1
                            .add(QualitychecklistModelUser.fromJson(element));
                      });
  ...
  Future<void> getTableData() async {
    ...
    if (documentSnapshot.exists) {
      ...
      data = mapData
          .map((map) => QualitychecklistModelUser.fromJson(map))
          .toList();
      checkTable = false;
    }
