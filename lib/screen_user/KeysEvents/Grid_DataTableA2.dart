...
import 'package:web_appllication/datasource_user/employee_datasource.dart';
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data.exists == false) {
                      ...
                      alldata.forEach((element) {
                        _employees.add(EmployeeUser.fromJson(element));
                        _employeeDataSource = EmployeeDataSource(
                            _employees,
                            context,
                            widget.userid!,
        ...
        value.docs.forEach((element) {
          ...
          if (element.id == '${widget.depoName}${widget.keyEvents}') {
            for (int i = 0; i < element.data()['data'].length; i++) {
              _employees.add(EmployeeUser.fromJson(element.data()['data'][i]));
              print(_employees);
            }
          }
        });
