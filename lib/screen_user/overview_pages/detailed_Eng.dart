...
import 'package:web_appllication/datasource_user/detailedengEV_datasource.dart';
...
class DetailedEngUser extends StatefulWidget {
  ...
  @override
  State<DetailedEngUser> createState() => _DetailedEngUsertState();
}
...
class _DetailedEngUsertState extends State<DetailedEngUser>
  ...
  List<DetailedEngModelUser> DetailedProject = <DetailedEngModelUser>[];
  List<DetailedEngModelUser> DetailedProjectev = <DetailedEngModelUser>[];
  List<DetailedEngModelUser> DetailedProjectshed = <DetailedEngModelUser>[];
  ...
  List<DetailedEngModelUser> getmonthlyReportEv() {
    return [
  ...
  List<DetailedEngModelUser> getmonthlyReportShed() {
    return [
      DetailedEngModelUser(
        siNo: 2,
        title: '',
  ...
  List<DetailedEngModelUser> getmonthlyReport() {
    return [
      // DetailedEngModelUser(
      //   siNo: 1,
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data.exists == false) {
                      ...
                      alldata.forEach((element) {
                        DetailedProject.add(
                            DetailedEngModelUser.fromjsaon(element));
                        _detailedDataSource = DetailedEngSource(
                            DetailedProject,
                            context,
                            widget.cityName.toString(),
