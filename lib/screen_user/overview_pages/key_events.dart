...
class KeyEventsUser extends StatefulWidget {
  ...
  String? cityName;
  String role;
  KeyEventsUser({Key? key, this.depoName, this.cityName,required this.role}) : super(key: key);

  @override
  _KeyEventsUserState createState() => _KeyEventsUserState();
}
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        if (snapshot.data.docs.length != 0) {
                          ...
                          Provider.of<KeyProviderUser>(context, listen: false)
