      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: CustomAppBar(
              ...
              // icon: Icons.logout,
              haveSynced: isFieldEditable ?  widget.showTable ? false : true : false,
              store: () {
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return SfDataGridTheme(
                            ...
                            child: SfDataGrid(
                              ...
                              //key: key,
                              allowEditing: isFieldEditable ? widget.showTable ? false : true : false,
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Visibility(
                          visible:isFieldEditable ? widget.showTable ? false : true : false,
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        ...
        const SizedBox(width: 10),
        Expanded(
          child: TextFormField(readOnly: !isFieldEditable,
