...
import 'package:web_appllication/model/user_model/employee.dart';
import 'package:web_appllication/provider/provider_user/key_provider.dart';
import 'package:web_appllication/screen_user/KeysEvents/Grid_DataTableA2.dart';
import 'package:web_appllication/screen_user/KeysEvents/Grid_DataTableA3.dart';
import 'package:web_appllication/screen_user/KeysEvents/Grid_DataTableA4.dart';
import 'package:web_appllication/screen_user/KeysEvents/Grid_DataTableA6.dart';
...
import 'package:web_appllication/widgets/widgets_user/keyEvents_data.dart';
import 'package:web_appllication/widgets/widgets_user/keyboard_listener.dart';
...
class KeyEvents2User extends StatefulWidget {
  /// Creates the home page.
  String? depoName;
  String? cityName;
  String role;
  KeyEvents2User({Key? key, this.depoName, this.cityName, required this.role})
      : super(key: key);

  @override
  _KeyEvents2UserState createState() => _KeyEvents2UserState();
}
...
class _KeyEvents2UserState extends State<KeyEvents2User> {
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData ||
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                Provider.of<KeyProviderUser>(context,
                                        listen: false)
                              ...
                              for (int i = 0; i < alldata.length; i++) {
                                ...
                                alldata.asMap().forEach((index, element) {
                                  ...
                                  if (!indicesToSkip.contains(index)) {
                                    _employees
                                        .add(EmployeeUser.fromJson(element));
  ...
  List<EmployeeUser> getDefaultData() {
    return [
      EmployeeUser(
        srNo: 1,
  ...
  List<EmployeeUser> getDefaultEmployeeData() {
    return [
      EmployeeUser(
          srNo: 'A1',
          activity: 'Letter of Award reveived  from TML',
