...
class DailyProjectUser extends StatefulWidget {
  String? cityName;
  String? depoName;
  String role;
  String? userId;
  ...
  @override
  State<DailyProjectUser> createState() => _DailyProjectUserState();
}
...
class _DailyProjectUserState extends State<DailyProjectUser> {
      ...
      floatingActionButton: isFieldEditable
          ? FloatingActionButton(
              onPressed: (() {
                globalItemLengthList.add(0);
                isShowPinIcon.add(false);
                dailyproject.add(DailyProjectModelUser(
                    siNo: 1,
  ...
  List<DailyProjectModelUser> getmonthlyReport() {
    return [
