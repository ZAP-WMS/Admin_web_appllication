...
import 'package:web_appllication/datasource_user/depot_overviewdatasource.dart';
import 'package:web_appllication/model/user_model/depot_overview.dart';
import 'package:web_appllication/provider/provider_user/hover_provider.dart';
import 'package:web_appllication/widgets/widgets_user/chart_data.dart';
import 'package:web_appllication/widgets/widgets_user/custom_appbar.dart';
import 'package:web_appllication/widgets/widgets_user/custom_textfield.dart';
import 'package:web_appllication/widgets/widgets_user/user_style.dart';
import '../KeysEvents/view_AllFiles.dart';

class DepotOverviewUser extends StatefulWidget {
  String? cityName;
  String? depoName;
  String userId;
  String role;
  ...
  @override
  State<DepotOverviewUser> createState() => _DepotOverviewUserState();
}

class _DepotOverviewUserState extends State<DepotOverviewUser> {
  bool isHover = false;
  late DepotOverviewDatasource _employeeDataSource;
  bool isProjectManager = false;
  List<DepotOverviewModelUser> _employees = <DepotOverviewModelUser>[];
      ...
      appBar: PreferredSize(
          ...
          child: CustomAppBar(
            ...
            store: () {
              ...
              FirebaseApiUser().nestedKeyEventsField('OverviewCollectionTable',
                            ...
                            Row(
                              children: [
                                Container(
                                    ...
                                    child: Consumer<HoverProviderUser>(
  ...
  List<DepotOverviewModelUser> getEmployeeData() {
    return [
      DepotOverviewModelUser(
          srNo: 1,
