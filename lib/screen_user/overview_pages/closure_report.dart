...
import 'package:web_appllication/datasource_user/closereport_datasource.dart';
import 'package:web_appllication/model/user_model/close_report.dart';
...
class ClosureReportUser extends StatefulWidget {
  String? cityName;
  String? depoName;
  String? userId;
  String role;
  ...
  @override
  State<ClosureReportUser> createState() => _ClosureReportUserState();
}
...
class _ClosureReportUserState extends State<ClosureReportUser> {
  ...
  List<ClosureReportModelUser> getcloseReport() {
    return [
