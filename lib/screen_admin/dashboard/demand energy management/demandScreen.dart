...
import 'package:web_appllication/screen_admin/dashboard/demand%20energy%20management/bar_graph.dart';
import 'package:web_appllication/screen_admin/dashboard/demand%20energy%20management/demand_table.dart';
...
class _DemandEnergyScreenState extends State<DemandEnergyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final provider =
        Provider.of<DemandEnergyProviderAdmin>(context, listen: false);
    final checkboxProvider =
        Provider.of<AllDepoSelectProviderAdmin>(context, listen: false);
  ...
  Future<void> getAllDepoDailyData() async {
    try {
      ...
      final provider = Provider.of<DemandEnergyProviderAdmin>(
        context,
        listen: false,
      );
      ...
      final selectedCityName = Provider.of<DemandEnergyProviderAdmin>(
        context,
        listen: false,
      ).selectedCity;
