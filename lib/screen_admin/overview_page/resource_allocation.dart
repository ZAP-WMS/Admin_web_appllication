...
class _ResourceAllocationState extends State<ResourceAllocation> {
  ...
  textproviderAdmin? _textprovider;
  String? data1,
      data2,
      data3,
      data4,
  ...
  @override
  void initState() {
    final textproviderAdmin _textprovider =
        Provider.of<textproviderAdmin>(context, listen: false);
    super.initState();
  ...
  Widget build(BuildContext context) {
    final textproviderAdmin _textprovider = Provider.of<textproviderAdmin>(context);
  ...
  cards() {
    return Consumer<textproviderAdmin>(builder: (context, value, child) {
      return Column(
        children: [
          Padding(
            padding: const EdgeInsets.all(10.0),
                ...
                Container(
                  ...
                  child: Center(
                    child: TextField(
                      ...
                      // onTap: (() => textprovider().editname()),
                      onChanged: (value) {
                        value = textproviderAdmin().editname();
                        data12 = value;
                      },
                      controller: _textEditingController12!
