...
class ElectricalQualityChecklistAdmin extends StatefulWidget {
  String? cityName;
  String? depoName;
  String? currentDate;
  bool? isHeader;
  ...
  @override
  State<ElectricalQualityChecklistAdmin> createState() =>
      _ElectricalQualityChecklistAdminState();
}

class _ElectricalQualityChecklistAdminState
    extends State<ElectricalQualityChecklistAdmin> {
  int currentIndex = 0;
