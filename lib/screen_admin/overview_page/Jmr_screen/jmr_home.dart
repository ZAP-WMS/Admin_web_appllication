...
import '../../../datasource_admin/jmr_datasource.dart';
import 'package:intl/intl.dart';

class JmrHomeAdmin extends StatefulWidget {
  String? userId;
  String? cityName;
  String? depoName;
  String? title;
...
class _JmrHomeAdminState extends State<JmrHomeAdmin> {
  ...
  List<JMRModelAdmin> convertListToJmrModel(List<List<dynamic>> data) {
    return data.map((list) {
      return JMRModelAdmin(
          srNo: list[0],
          Description: list[1],
          Activity: list[2],
          RefNo: list[3],
