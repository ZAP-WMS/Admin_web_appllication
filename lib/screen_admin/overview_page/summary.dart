...
import '../../datasource_admin/monthlyproject_datasource.dart';
import '../../datasource_admin/safetychecklist_datasource.dart';

class ViewSummaryAdmin extends StatefulWidget {
  String? depoName;
  String? cityName;
  String? id;
  String? selectedtab;
  ...
  @override
  State<ViewSummaryAdmin> createState() => _ViewSummaryAdminState();
}

class _ViewSummaryAdminState extends State<ViewSummaryAdmin> {
  DateTime? startdate = DateTime.now();
  DateTime? rangestartDate;

  List<MonthlyProjectModelAdmin> monthlyProject = <MonthlyProjectModelAdmin>[];
  List<SafetyChecklistModelAdmin> safetylisttable =
      <SafetyChecklistModelAdmin>[];
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            alldata.forEach((element) {
                              monthlyProject.add(
                                  MonthlyProjectModelAdmin.fromjson(element));
                              monthlyDataSource =
                    ...
                    ? Expanded(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            alldata.forEach((element) {
                              dailyproject.add(
                                  DailyProjectModelAdmin.fromjson(element));
                            ...
                            child: StreamBuilder(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (!snapshot.hasData ||
                                  ...
                                  alldata.forEach((element) {
                                    safetylisttable.add(
                                        SafetyChecklistModelAdmin.fromJson(
                                            element));
