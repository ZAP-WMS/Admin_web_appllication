...
import 'package:web_appllication/datasource_admin/closereport_datasource.dart';
...
import '../../model/admin_model/close_report.dart';

class ClosureReportAdmin extends StatefulWidget {
  String role;
  String? userId;
  String? cityName;
  String? depoName;
  ClosureReportAdmin(
      {super.key, this.userId, required this.cityName, required this.depoName,required this.role});

  @override
  State<ClosureReportAdmin> createState() => _ClosureReportAdminState();
}

class _ClosureReportAdminState extends State<ClosureReportAdmin> {
  List<ClosureReportModelAdmin> closereport = <ClosureReportModelAdmin>[];
  ...
  List<ClosureReportModelAdmin> getcloseReport() {
    return [
