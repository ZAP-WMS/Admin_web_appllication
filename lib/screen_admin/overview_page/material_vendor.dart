...
import '../../datasource_admin/materialprocurement_datasource.dart';
import '../../model/admin_model/material_vendor.dart';
...
class _MaterialProcurementAdminState extends State<MaterialProcurementAdmin> {
  List<MaterialProcurementModelAdmin> _materialprocurement =
    ...
    return Scaffold(
        appBar: PreferredSize(
            ...
            child: CustomAppBar(
              ...
              makeAnEntryPage: MaterialProcurementUser(
          role: widget.role,
                      ...
                      if (!snapshot.hasData || snapshot.data.exists == false) {
                        ...
                        alldata.forEach((element) {
                          _materialprocurement.add(
                              MaterialProcurementModelAdmin.fromjsaon(element));
                          _materialDatasource = MaterialDatasource(
  ...
  List<MaterialProcurementModelAdmin> getmonthlyReport() {
    return [
      MaterialProcurementModelAdmin(
          cityName: '',
          details: '',
    ...
    var res = await FirebaseFirestore.instance
      ...
      value.docs.forEach((element) {
        for (int i = 0; i < element.data()["data"].length; i++) {
          ...
          _materialprocurement.add(MaterialProcurementModelAdmin.fromjsaon(
              element.data()['data'][i]));
