...
import 'package:web_appllication/model/admin_model/energy_management.dart';
...
import '../../datasource_admin/energymanagement_datasource.dart';
import '../../components/loading_page.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../../provider/provider_admin/energy_provider.dart';
...
class _EnergyManagementAdminState extends State<EnergyManagementAdmin> {
  ...
  List<EnergyManagementModelAdmin> energyManagement =
      <EnergyManagementModelAdmin>[];
          ...
          await FirebaseFirestore.instance
            ...
            if (value.data() != null) {
              ...
              for (int j = 0; j < value.data()!['data'].length; j++) {
                energyManagement.add(EnergyManagementModelAdmin.fromJson(
                    value.data()!['data'][j]));
