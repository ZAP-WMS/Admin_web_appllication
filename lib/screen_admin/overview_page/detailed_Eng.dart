...
import '../../datasource_admin/detailedengEV_datasource.dart';
import '../../datasource_admin/detailedengShed_datasource.dart';
import '../../datasource_admin/detailedeng_datasource.dart';
            ...
            widget.role == "projectManager" ? Container(
              margin:const EdgeInsets.all(8.0),
                child: ElevatedButton(
                    onPressed: () {
                    widget.role == 'projectManager' ?  Navigator.push(
                        context,
                        MaterialPageRoute(
                    ...
                    onSuggestionSelected: (suggestion) {
                      ...
                      if (widget.cityName.toString().isNotEmpty) {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => DetailedEngAdmin(
