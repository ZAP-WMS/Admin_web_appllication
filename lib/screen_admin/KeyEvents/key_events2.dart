...
import 'package:web_appllication/model/admin_model/employee.dart';
...
import 'package:web_appllication/widgets/widgets_admin/keyEvents_data.dart';
import 'package:web_appllication/widgets/widgets_admin/keyboard_listener.dart';
import '../../components/loading_page.dart';
import '../../datasource_admin/key_datasource.dart';
import '../../provider/provider_admin/key_provider.dart';

/// The application that contains datagrid on it.

/// The home page of the application which hosts the datagrid.
class KeyEvents2Admin extends StatefulWidget {
  ...
  @override
  _KeyEvents2AdminState createState() => _KeyEvents2AdminState();
}

class _KeyEvents2AdminState extends State<KeyEvents2Admin> {
  // ignore: non_constant_identifier_names
  late KeyDataSourceKeyEvents _KeyDataSourceKeyEvents;
  List<EmployeeAdmin> _employees = <EmployeeAdmin>[];
  ...
  @override
  void initState() {
    _keyProvider = Provider.of<KeyProviderAdmin>(context, listen: false);
        ...
        : keyBoardArrow(
            ...
            myScaffold: Scaffold(
                appBar: PreferredSize(
                    ...
                    child: CustomAppBar(
                      isProjectManager:
                          widget.role == "projectManager" ? true : false,
                      makeAnEntryPage: KeyEvents2User(
                        role: widget.role,
                        cityName: widget.cityName,
                        depoName: widget.depoName,
                      ),
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData ||
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                Provider.of<KeyProviderAdmin>(context,
                                        listen: false)
                              ...
                              for (int i = 0; i < alldata.length; i++) {
                                ...
                                alldata.asMap().forEach((index, element) {
                                  ...
                                  if (!indicesToSkip.contains(index)) {
                                    _employees
                                        .add(EmployeeAdmin.fromJson(element));
  ...
  List<EmployeeAdmin> getDefaultData() {
    return [
      EmployeeAdmin(
        srNo: 1,
  ...
  List<EmployeeAdmin> getDefaultEmployeeData() {
    return [
      EmployeeAdmin(
          srNo: 'A1',
          activity: 'Letter of Award reveived  from TML',
  ...
  List<EmployeeAdmin> getEmployeeData() {
    return [
      EmployeeAdmin(
          srNo: 'A1',
          activity: 'Letter of Award reveived  from TML',
