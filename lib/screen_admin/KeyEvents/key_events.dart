...
import 'package:web_appllication/FirebaseApi/firebase_api_admin.dart';
...
class KeyEventsAdmin extends StatefulWidget {
  /// Creates the home page.
  String? userId;
  String? depoName;
  String? cityName;
  KeyEventsAdmin({Key? key, required this.userId, this.depoName, this.cityName})
      : super(key: key);

  @override
  _KeyEventsAdminState createState() => _KeyEventsAdminState();
}

class _KeyEventsAdminState extends State<KeyEventsAdmin> {
      ...
      var res = await FirebaseFirestore.instance
        ...
        value.docs.forEach((element) {
          for (int i = 0; i < element.data().length; i++) {
            ...
            _employees.add(EmployeeAdmin.fromJson(element.data()[i]));
