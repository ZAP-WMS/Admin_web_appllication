...
import 'package:web_appllication/screen_user/overview_pages/key_events.dart';
                          ...
                          return Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: CircularPercentIndicator(
                                radius: 20.0,
                                lineWidth: 5.0,
                                percent: (Provider.of<KeyProviderUser>(context)
                                        .totalvalue
                                        .toInt()) /
                                    100,
                                center: Text(
                                                                ...
                                                                : widget.toChecklist
                                                                    ...
                                                                    : widget.toTesting
                                                                        ? Navigator.pushReplacement(
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => TestingReportUser(
                                                                                role: widget.role!,
                                                                                cityName: widget.cityname,
                                                                                depoName: suggestion,
                                                                              ),
                                                                        ...
                                                                        : widget.toClosure
                                                                            ? Navigator.pushReplacement(
                                                                                context,
                                                                                MaterialPageRoute(
                                                                                  builder: (context) => ClosureReportUser(
                                                                                    role: widget.role!,
                                                                                    depoName: suggestion,
                                                                                    cityName: widget.cityname,
                                                                                  ),
